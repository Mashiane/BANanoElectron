...
Sub BuildDrawer
	...
	vm.Drawer.AddListItem(vm.CreateListItem("drwhome", Me).SetItemTo("/").SetTitle("Home").SetActiveClass("activeitem")).AddListItemDivider
	vm.Drawer.AddListItem(vm.CreateListItem("drwmenu", Me).SetItemTo("/plans").SetTitle("Menu").SetActiveClass("activeitem")).AddListItemDivider
	vm.Drawer.AddListItem(vm.CreateListItem("drwprofile", Me).SetItemTo("/about").SetTitle("Profile").SetActiveClass("activeitem")).AddListItemDivider
	vm.Drawer.AddListItem(vm.CreateListItem("drwsignin", Me).SetItemTo("/signin").SetTitle("Sign In").SetActiveClass("activeitem")).AddListItemDivider
	vm.Drawer.AddListItem(vm.CreateListItem("drwjoin", Me).SetItemTo("/join").SetTitle("Sign Up").SetActiveClass("activeitem"))
